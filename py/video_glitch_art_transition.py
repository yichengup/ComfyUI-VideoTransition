...
class VideoGlitchArtTransitionNode(ComfyNodeABC):
    ...
    async def generate_glitch_art_transition(
        ...
        print(f"Starting glitch art transition: {glitch_style}, {total_frames} frames")
        ...
        print(f"Glitch art transition completed: {video_tensor.shape} in {total_time:.2f}s")
...
<body>
    ...
    <div class="loading" id="loading">Initializing glitch art system...</div>
        ...
        class GlitchController {{
            ...
            async init() {{
                try {{
                    ...
                    // console.log('🔥 GlitchController initialized, style=' + this.glitchStyle);
                }} catch (error) {{
                    console.error('Glitch art system init failed:', error);
                }}
            }}
            ...
            updateFrame(progress, texture1Base64, texture2Base64) {{
                ...
                try {{
                    ...
                    console.error('Glitch update failed:', error);
                }}
            }}
